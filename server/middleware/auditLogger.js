      ...
      setImmediate(async () => {
        try {
          ...
          const logData = {
            ...
            username:
              req.session?.user?.username || req.body?.username || "Anonymous",
            email:
            ...
            status:
              res.statusCode >= 200 && res.statusCode < 300
                ...
                : "FAILED",
            errorMessage:
              data.message && res.statusCode >= 400 ? data.message : null,
          };
          ...
          switch (action) {
            ...
            case "LOGIN_FAILED":
              logData.input =
                req.body?.emailOrUsername || req.body?.email || "Unknown";
              logData.result = isSuccess
                ? "Login successful"
            ...
            default:
              // No additional input/result for other actions
              break;
          }
